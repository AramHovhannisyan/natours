...
var stripe = Stripe('pi_3KizlBGFG4LxFJeZ0JnteevY');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session.data.session.id); // create checkout form + charge credit card
...
var logoutBtn = document.querySelector('.nac__el--logout');
